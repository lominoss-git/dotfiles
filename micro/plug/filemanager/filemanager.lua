...
local function refresh_view()
	...
	if tree_view:GetView().Width < 26 then
		tree_view:ResizePane(26)
	end
...
local function compress_target(y, delete_y)
	...
	if tree_view:GetView().Width > (26 + highest_visible_indent) then
		-- Shave off some width
        tree_view:ResizePane(26 + highest_visible_indent)
	end
